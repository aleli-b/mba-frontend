    ...
    return (
        <div className="form-container bg-gray-700 flex justify-center items-center">
            ...
            >
                ...
                {showAlert &&
                    <div id="alert-border-3" class="flex p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-900 dark:border-green-800" role="alert">
